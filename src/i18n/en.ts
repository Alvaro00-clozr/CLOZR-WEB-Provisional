export const enDictionary = {
  ...
  hero: {
    eyebrow: 'Revenue Operating System for D2C Brands',
    titleStart: 'The',
    rotatingPhrases: ['truth', 'reality', 'data', 'signal'],
    titleEnd: 'about your revenue.',
    descriptionLine1: 'Real cash collected. Real ad spend matched. No platform illusions.',
    descriptionLine2: 'Know exactly what your business makes.',
    primaryCta: 'Request access',
    secondaryCta: 'See how it works',
    backgroundAlt: '',
    counters: {
      roasLabel: 'Avg Real ROAS',
      wasteLabel: 'Wasted spend cut',
      cashLabel: 'Revenue tracked',
    },
    dashboard: {
      title: 'CLOZR — Truth Dashboard',
      date: '01 Jan – 31 Mar 2026',
      tabAnalysis: 'Analysis',
      tabTable: 'Table',
      cashCollected: 'Total Cash Collected',
      cashSub: 'Real cash in bank',
      adSpend: 'Total Ad Spend',
      adSpendSub: 'Meta + Google',
      netProfit: 'Real Net Profit',
      netProfitSub: 'Cash − Ad spend',
      platformClaims: 'Platform Claims vs Real Cash',
      realRoas: 'Real ROAS',
      realRoasSub: 'Cash in bank / Ad spend',
    },
  },
  attribution: {
    eyebrow: 'THE ATTRIBUTION ILLUSION',
    titleLine: "The 20% You're Losing",
    titlePrefix: '(And',
    titleHighlight: "Don't See)",
    titleSuffix: '',
    paragraphs: [
      'Every D2C brand faces the same invisible issue: ad platforms report revenue, while your bank records what actually arrived.',
      'That difference includes failed payments, refunds, chargebacks, and processing costs. None of these are reflected in your reported ROAS.',
      "Meta doesn't subtract these losses. Google Ads doesn't subtract them either.",
      'So when your dashboard shows a 4.0 ROAS, your real return might already be closer to 2.8.',
      "You're not scaling profit. You're scaling distorted data.",
    ],
    chart: {
      ariaLabel: 'Reported versus collected ROAS comparison chart',
      badge: '-30%',
      labels: {
        claimedLine1: 'Reported',
        claimedLine2: 'ROAS',
        bankLine1: 'Collected',
        bankLine2: 'ROAS',
      },
  ...
  solution: {
    eyebrow: 'WHAT CLOZR DOES',
    titleLine1: "CLOZR Reconciles What's",
    titleLine2: "Reported With What's Real",
    cards: {
      failedPaymentLeakage: {
        titleLine1: 'Reported ROAS',
        titleLine2: 'vs Real ROAS',
        points: [
          'Not another dashboard. Not another attribution model.',
          'A financial truth layer on top of your stack.',
        ],
      },
      refundArbitrage: {
        titleLine1: 'Revenue After',
        titleLine2: 'Refunds and Failed Payments',
        points: [
          'Every deduction is reconciled before decisions are made.',
          'You see what actually made money, not what platforms report.',
        ],
      },
      chargebackBleeding: {
        titleLine1: 'Real CAC',
        titleLine2: 'Not Platform CAC',
        points: [
          'Acquisition cost is tied to collected cash, not reported attribution.',
          'Capital is allocated with financial reality, not assumptions.',
        ],
      },
      attributionLies: {
        titleLine1: 'Channel-Level',
        titleLine2: 'Profitability',
        points: [
          "You don't see performance. You see what actually made money.",
          'You cut losses early and scale what is truly profitable.',
        ],
      },
    },
  },
  advisory: {
    ...
    title: 'CLOZR ADVISORY PROGRAM',
    subtitle: 'For D2C brands exceeding EUR 500K monthly revenue',
    panelTitle: 'Strategic Revenue Operations Partnership',
    panelLabel: 'Application Only',
    ctaLabel: 'Apply for Partnership',
  },
  socialProof: {
    eyebrow: 'SOCIAL PROOF & DATA',
    headline: "Used by Brands That Can't Afford to Be Wrong",
    subcopy:
      'Operators managing EUR 500K-EUR 10M/month who need to know what is real.',
    ...
    testimonial:
      'Before CLOZR, we thought we were profitable. After CLOZR, we discovered we were bleeding EUR 40K/month in untracked refunds.',
    testimonialAuthor: '[Founder Name], [Brand Name]',
  },
  howItWorks: {
    eyebrow: 'HOW IT WORKS',
    title: 'Connected. Reconciled. Clear.',
    steps: [
      {
        number: '01',
        title: 'Connect your platforms',
        body: 'Link Stripe, Meta, and Google. CLOZR pulls real revenue and real ad spend — no manual uploads, no CSV exports.',
      },
      {
        number: '02',
        title: 'Revenue is reconciled',
        body: 'Platform claims are matched against actual bank receipts from Stripe. The gap is calculated automatically, per platform, per campaign.',
      },
      {
        number: '03',
        title: 'Make decisions on truth',
        body: 'Act on Real ROAS, Real CAC, and Real Net Profit. Scale what actually works. Cut what only looked good in the platform dashboard.',
      },
    ],
  },
  pricing: {
    eyebrow: 'PRICING',
    support: 'Investment',
    headline: 'Choose your control layer',
    ...
    comparison: {
      ...
      rows: [
        ...
        {
          feature: 'RevOps Consulting',
          starter: 'No',
          professional: '2x/month',
          scale: 'Weekly',
        },
        {
          feature: 'SKU-Level Analysis',
          starter: 'No',
          professional: 'Yes',
          scale: 'Yes',
        },
    ...
    plans: {
      starter: {
        name: 'Starter',
        price: '€149/month',
        subtitle: 'Entry-level revenue reconciliation for D2C operators',
        description: "WHAT'S INCLUDED:",
        features: [
          'Real ROAS and real CAC by channel',
          'Stripe + Meta + Google reconciliation',
          'First 90 days of historical data',
          'Up to 5,000 monthly transactions',
          'Dashboard access (view-only for team)',
          'Email support (48h response time)',
        ],
        planNote: 'SaaS-only plan',
        planNoteSupport: 'No RevOps consulting included',
        cta: 'Start Free Trial',
      },
      professional: {
        name: 'Professional',
        price: '€497/month',
        subtitle: 'Full profitability intelligence for serious D2C operators',
        description: 'Know your real ROAS, real CAC, SKU-level profit and revenue leakage across every channel.',
        features: [
          'Unlimited monthly transactions',
          'SKU-level profit analysis',
          'Failed payments recovery tracking',
          'Multi-channel attribution (Meta + Google + TikTok)',
          'Chargeback & refund reconciliation',
          '2x monthly RevOps strategy sessions (60 min each)',
          'Priority Slack support (4h response time)',
          'Quarterly financial health audit',
        ],
        planNote: 'Includes integrated RevOps consulting',
        planNoteSupport: 'No additional fees',
        cta: 'Start Free Trial',
      },
      growthPartner: {
        name: 'Scale',
        ...
        features: [
          'Multi-brand operations (multiple Stripe accounts)',
          'Custom dashboards & white-label reports',
          'Dedicated RevOps Partner (weekly sessions)',
          'API access for internal tools',
          'Compliance audits & advanced fraud detection',
          'Priority feature development',
          '24/7 Slack support (1h SLA)',
        ],
        planNote: 'Requires onboarding call',
        planNoteSupport: '',
        cta: 'Book a Call',
      },
      foundingPartner: {
  ...
  revenueAuditCta: {
    headlineLine1: 'Stop flying blind.',
    headlineLine2: 'Start with real numbers.',
    subcopy: 'Request access today and know what your business actually makes.',
    ctaLabel: 'Request access',
    footnote: 'Built for operators who care about real money.',
  },
  contact: {
    eyebrow: 'CONTACT',
    support: 'Start the conversation',
    headline: 'See Where Your Profit Is Leaking',
    description: "We'll show you exactly what's happening in your numbers.",
    ...
    form: {
      ...
      monthlyRevenue: 'Monthly Revenue (GMV)',
      monthlyRevenuePlaceholder: 'Select a range',
      monthlyRevenueOptions: ['<€50K', '€50K-100K', '€100K-500K', '€500K+'],
      message: "What's bleeding your revenue?",
      ...
      hints: {
        ...
        message: 'Optional. Maximum 1200 characters.',
      },
      validation: {
        ...
        revenueRequired: 'Please select your monthly revenue range.',
  ...
  legalPages: {
    shared: {
      ...
      contactEmail: 'privateaccess@clozr.eu',
      noteTitle: 'Important',
      noteBody:
    ...
    terms: {
      ...
      sections: [
        ...
        },
        {
          heading: '14. Contact',
          paragraphs: [
            'For legal notices, contractual questions, or requests related to these Terms, contact CLOZR at privateaccess@clozr.eu.',
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            'For privacy-related requests, you can contact privateaccess@clozr.eu.',
          ],
        },
        {
