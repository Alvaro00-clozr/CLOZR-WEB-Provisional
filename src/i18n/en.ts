export const enDictionary = {
  ...
  attribution: {
    ...
    titlePrefix: '(And',
    titleHighlight: "Don't Know It)",
    titleSuffix: '',
    paragraphs: [
      'Every D2C brand faces the same invisible crisis: ad platforms report gross revenue, while your bank receives net revenue.',
      'The gap includes failed payments (3-8% of transactions never clear), chargebacks (0.5-2% dispute rate), refunds (10-25% in fashion, 5-15% in beauty), and processing fees (2.9% + EUR 0.30 per transaction).',
      "Meta Ads doesn't subtract these losses. Google Ads doesn't subtract these losses.",
      'So when Ads Manager shows ROAS 4.0, your collected ROAS can be 2.8.',
      'You are scaling campaigns that destroy margin.',
      'CLOZR reconciles every euro, every transaction, every refund in real time.',
      'You see what you actually made, not what the algorithm reports.',
    ],
    chart: {
  ...
  solution: {
    eyebrow: 'WHAT WE STOP',
    titleLine1: 'Leak-by-Leak',
    titleLine2: 'Margin Protection.',
    cards: {
      failedPaymentLeakage: {
        titleLine1: 'Failed Payment',
        titleLine2: 'Leakage',
        points: [
          'Identify which campaigns drive customers whose payments fail most often.',
          'Stop spending on high-intent, low-collection audiences.',
        ],
      },
      refundArbitrage: {
        titleLine1: 'Refund',
        titleLine2: 'Arbitrage',
        points: [
          'See which products run 30%+ return rates.',
          'Kill SKUs that look profitable but destroy margin.',
        ],
      },
      chargebackBleeding: {
        titleLine1: 'Chargeback',
        titleLine2: 'Bleeding',
        points: [
          'Track which acquisition channels carry the highest dispute rates.',
          'Cut fraud-prone traffic sources before they scale.',
        ],
      },
      attributionLies: {
        titleLine1: 'Attribution',
        titleLine2: 'Lies',
        points: [
          'Meta says you made EUR 100K. Stripe deposited EUR 78K.',
          'CLOZR exposes the EUR 22K gap and where it went.',
        ],
      },
    },
  },
  ...
  socialProof: {
    ...
    headline: "Trusted By Brands That Can't Afford Guesswork",
    subcopy:
      'D2C operators managing EUR 500K-EUR 10M monthly revenue rely on CLOZR to reconcile the truth.',
  ...
  revenueAuditCta: {
    ...
    bodyLine2: 'Request a 15-minute revenue audit.',
    bodyLine3: "We'll show you exactly where you're bleeding.",
    bodyLine4: 'No fluff. No sales pitch.',
    bodyLine5: 'Just your numbers. Your gaps. Your reality.',
    ctaLabel: 'Request Audit',
  },
  contact: {
    eyebrow: 'CONTACT',
    support: 'Start the conversation',
    headline: "Let's Talk Revenue",
    description: 'See exactly where your profits are leaking in 15 minutes.',
