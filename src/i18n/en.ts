export const enDictionary = {
  ...
  pricing: {
    ...
    plans: {
      starter: {
        name: 'Starter',
        price: '297 €/month',
        subtitle: 'Essential revenue reconciliation for D2C operators',
        description: "WHAT'S INCLUDED:",
        features: [
          'Stripe <-> Meta Ads reconciliation',
          'Real ROAS vs Reported ROAS tracking',
      ...
      growthPartner: {
        ...
        features: [
          'Multi-entity support (multiple Stripe accounts)',
          'Custom dashboard & white-label reports',
          'Dedicated RevOps Partner (weekly sessions)',
          'API access for internal tools',
          'Advanced fraud detection & compliance audits',
          'Priority feature development',
          '24/7 Slack support (1h SLA)',
        ],
        planNote: 'Built for brands exceeding EUR 500K/month revenue',
        planNoteSupport: '',
        cta: 'Contact Sales',
      },
    },
  ...
  revenueAuditCta: {
    ...
    headline: "Find Where You're Losing Money",
    bodyLine1:
      'Every day you operate without revenue reconciliation is another day of profit leaking into the void.',
    bodyLine2: 'No demo pitch. No generic advice.',
    bodyLine3: 'Just your numbers.',
    bodyLine4: 'Your gaps.',
    bodyLine5: 'Your reality.',
    ctaLabel: 'Request your revenue audit',
  },
  contact: {
    eyebrow: 'CONTACT',
