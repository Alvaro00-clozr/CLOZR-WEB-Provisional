        ...
        <div className="mx-auto max-w-[980px]">
          ...
          <div className="mt-12 grid gap-4 lg:grid-cols-[1.3fr_0.7fr]">
            ...
            >
              ...
              />
              <form className="relative grid gap-3" action="#" method="post">
                <div className="grid gap-3 sm:grid-cols-2">
                  <label className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      type="text"
                      required
                      className="h-11 rounded-[10px] border border-[color-mix(in_srgb,var(--text-muted)_24%,transparent)] bg-[color-mix(in_srgb,var(--bg-card)_78%,transparent)] px-3 text-[var(--text-primary)] outline-none transition-colors focus:border-[color-mix(in_srgb,var(--brand-info)_58%,transparent)]"
                    />
                  </label>
                  <label className="flex flex-col gap-1.5">
                ...
                <label className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    rows={5}
                    required
                    className="min-h-[132px] rounded-[10px] border border-[color-mix(in_srgb,var(--text-muted)_24%,transparent)] bg-[color-mix(in_srgb,var(--bg-card)_78%,transparent)] px-3 py-2.5 text-[var(--text-primary)] outline-none transition-colors focus:border-[color-mix(in_srgb,var(--brand-info)_58%,transparent)]"
                  />
                </label>

                <button type="submit" className="btn-gradient body mt-2 inline-flex h-12 w-full items-center justify-center">
